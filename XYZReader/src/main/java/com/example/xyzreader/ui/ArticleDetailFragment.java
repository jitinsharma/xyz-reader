...
public class ArticleDetailFragment extends Fragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        /*ImageView imageView = (ImageView)mRootView.findViewById(android.R.id.home);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* mScrollView = (ObservableScrollView) mRootView.findViewById(R.id.scrollview);
        ...
        shareButton = (FloatingActionButton)mRootView.findViewById(R.id.share_button);
    ...
    private void bindViews() {
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                //mutedColor = p.getMutedColor(R.attr.colorPrimary);
                                //updateStatusBar();
                            }
                            /*if (bitmap != null) {
                                Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
                                    ...
                                    public void onGenerated(Palette palette) {
                                        collapsingToolbar.setContentScrimColor(palette.getVibrantSwatch().getRgb());
                                        *//*Window window = getActivity().getWindow();
        ...
        if (!Utility.isNetworkStatusAvailable(getActivity())){
            Snackbar.make(mRootView, "No internet connection", Snackbar.LENGTH_LONG)
